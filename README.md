...
Генерация БД  СПР AMAS производится мной по заявку, оставленной на сайте www.spramas.ru
...
Вы не имеете права генерировать или каким-либо иным способом создавать Базу данных СПР AMAS
