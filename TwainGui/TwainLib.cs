...
public class Twain
	{
	private const short CountryRU		= 7;
	private const short LanguageRU		= 7;
	...
	public Twain()
        ...
        appid.Version.Language = LanguageRU;
        appid.Version.Country = CountryRU;
		appid.Version.Info		= "AMASAsqure";
		...
		appid.Manufacturer		= "AMAS";
		appid.ProductFamily		= "AMASWare";
		appid.ProductName		= "AMAS";
